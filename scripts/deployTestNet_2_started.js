...
async function main() {
    ...
    LameloRaffleArtifacts = await ethers.getContractFactory("LameloRaffleV2");
    ...
    console.log("");
    console.log( 
        "npx hardhat verify --network rinkeby --contract contracts/LameloRaffleV2.sol:LameloRaffleV2",
